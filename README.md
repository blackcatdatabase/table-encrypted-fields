...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 0 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 2 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\encrypted-fields](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\encrypted-fields)
...
graph LR
  ...
  encrypted_fields["encrypted_fields"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encrypted-fields -Apply
