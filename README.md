...
> Lineage: 0 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 2 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\encrypted-fields](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\encrypted-fields) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encrypted-fields -Apply
