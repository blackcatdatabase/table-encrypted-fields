 ...
 * - whitelist filtrů: [ 'id', 'entity_table', 'entity_pk', 'field_name', 'ciphertext', 'meta', 'created_at', 'updated_at' ]
 * - whitelist pro LIKE hledání: [ 'entity_table', 'entity_pk', 'field_name' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'entity_table', 'entity_pk', 'field_name', 'ciphertext', 'meta', 'created_at', 'updated_at' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'entity_table', 'entity_pk', 'field_name' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'entity_table', 'entity_pk', 'field_name', 'ciphertext', 'meta', 'created_at', 'updated_at' ], true);
            $parts = [];
