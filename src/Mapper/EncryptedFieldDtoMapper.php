...
namespace BlackCat\Database\Packages\EncryptedFields\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO EncryptedFieldDto:
 ...
 */
final class EncryptedFieldDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'entity_table' => 'entityTable', 'entity_pk' => 'entityPk', 'field_name' => 'fieldName', 'ciphertext' => 'ciphertext', 'meta' => 'meta', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    ...
    /** @var string[] */
    private const BIN_COLS    = [ 'ciphertext' ];
     ...
     * @return EncryptedFieldDto
     */
    public static function fromRow(array $row): EncryptedFieldDto
    {
        /** @var EncryptedFieldDto */
        return DtoHydrator::fromRow(
            EncryptedFieldDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EncryptedFieldDto
    {
     ...
     *
     * @param EncryptedFieldDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EncryptedFieldDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EncryptedFieldDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EncryptedFieldDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EncryptedFieldDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EncryptedFieldDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EncryptedFieldDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EncryptedFieldDto>
     */
