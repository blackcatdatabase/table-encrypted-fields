...
{
    private EncryptedFieldRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EncryptedFieldRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptedFields\Dto\EncryptedFieldDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EncryptedFields\Dto\EncryptedFieldDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptedFields\Dto\EncryptedFieldDto|null
    {
