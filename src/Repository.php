...
use BlackCat\Database\Packages\EncryptedFields\Repository\EncryptedFieldRepository as GeneratedRepository;
...
{
  private EncryptedFieldRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EncryptedFieldRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EncryptedFieldRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptedFields\Dto\EncryptedFieldDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptedFields\Dto\EncryptedFieldDto|null { return $this->repo->getById($id, $asDto); }
