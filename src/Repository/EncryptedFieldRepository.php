...
final class EncryptedFieldRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`encrypted_fields`' : '"encrypted_fields"';
     ...
     * [ 'entity_table', 'entity_pk', 'field_name' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'ciphertext', 'meta', 'updated_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $upd  = [ 'ciphertext', 'meta', 'updated_at' ];
